...
let AccountsService = class AccountsService {
    ...
    async ensureDefaultChartOfAccounts(companyId) {
        ...
        if (count > 0)
            return;
        const defaults = [
            { name: 'Cash', category: client_1.AccountCategory.ASSET, subCategory: client_1.AccountSubCategory.CURRENT_ASSET },
            { name: 'Bank Accounts', category: client_1.AccountCategory.ASSET, subCategory: client_1.AccountSubCategory.CURRENT_ASSET },
            { name: 'Accounts Receivable', category: client_1.AccountCategory.ASSET, subCategory: client_1.AccountSubCategory.CURRENT_ASSET },
            { name: 'Inventory', category: client_1.AccountCategory.ASSET, subCategory: client_1.AccountSubCategory.CURRENT_ASSET },
            { name: 'Machinery', category: client_1.AccountCategory.ASSET, subCategory: client_1.AccountSubCategory.FIXED_ASSET },
            { name: 'Accounts Payable', category: client_1.AccountCategory.LIABILITY, subCategory: client_1.AccountSubCategory.CURRENT_LIABILITY },
            { name: 'GST Payable', category: client_1.AccountCategory.LIABILITY, subCategory: client_1.AccountSubCategory.CURRENT_LIABILITY },
            { name: 'Owners Capital', category: client_1.AccountCategory.EQUITY, subCategory: client_1.AccountSubCategory.EQUITY },
            { name: 'Drawings', category: client_1.AccountCategory.EQUITY, subCategory: client_1.AccountSubCategory.EQUITY },
            { name: 'Retained Earnings', category: client_1.AccountCategory.EQUITY, subCategory: client_1.AccountSubCategory.EQUITY },
            { name: 'Opening Balance Equity', category: client_1.AccountCategory.EQUITY, subCategory: client_1.AccountSubCategory.EQUITY },
            { name: 'Sales Revenue', category: client_1.AccountCategory.REVENUE, subCategory: client_1.AccountSubCategory.SALES_REVENUE },
            { name: 'Service Revenue', category: client_1.AccountCategory.REVENUE, subCategory: client_1.AccountSubCategory.SERVICE_REVENUE },
            { name: 'Cost of Goods Sold', category: client_1.AccountCategory.EXPENSE, subCategory: client_1.AccountSubCategory.COGS },
            { name: 'Salary Expense', category: client_1.AccountCategory.EXPENSE, subCategory: client_1.AccountSubCategory.OPERATING_EXPENSE },
            { name: 'Rent Expense', category: client_1.AccountCategory.EXPENSE, subCategory: client_1.AccountSubCategory.OPERATING_EXPENSE },
            { name: 'Utilities Expense', category: client_1.AccountCategory.EXPENSE, subCategory: client_1.AccountSubCategory.OPERATING_EXPENSE },
            { name: 'Bank Charges', category: client_1.AccountCategory.EXPENSE, subCategory: client_1.AccountSubCategory.OTHER_EXPENSE },
            { name: 'Travel Expense', category: client_1.AccountCategory.EXPENSE, subCategory: client_1.AccountSubCategory.OPERATING_EXPENSE },
        ];
    ...
    async getProfitLoss() {
        ...
        const revenueItems = items.filter(i => i.category === client_1.AccountCategory.REVENUE);
        return {
            revenue: {
                ...
                unclassified: revenueItems.filter(i => !['SALES_REVENUE', 'SERVICE_REVENUE', 'OTHER_INCOME'].includes(i.subCategory)),
            },
